part of "package:graph_auth_mobile/core/widgets/cupertino_back/cupertino_back_gesture.dart";
...
class _CupertinoBackGestureDetectorState<T> extends State<_CupertinoBackGestureDetector<T>> {
  ...
  double get _backGestureWidth {
    final BackGestureWidthGetter backGestureWidth = BackGestureWidthTheme.of(context);
